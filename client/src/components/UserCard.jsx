...
const UserCard = ({ name, skillsOffered, skillsWanted, rating, onRequest }) => {
  const handleRequest = () => {
    onRequest(name);
  };
  ...
  return (
    <div style={{ border: '2px solid #FFFFFF', padding: '10px', borderRadius: '10px', margin: '20px 0', background: '#000000', display: 'flex', alignItems: 'center' }}>
      ...
      <button
        style={{ border: '2px solid #FFFFFF', background: '#008080', color: '#FFFFFF', padding: '5px 15px', borderRadius: '5px' }}
